...
{
    public class ThrowOfNightProjectile : ModProjectile
    {
        ...
        {                                                           // sound that the projectile make when hitting the terrain
            {
				...
				if (Main.rand.Next(10) == 0){
					Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, (mod.ItemType("ThrowOfNight")));
				}
