...
{
    public class ShurikenOfTheEarthProjectile : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            projectile.penetrate = 172;      //this is how many enemy this projectile penetrate before disappear
        ...
        {                                                           // sound that the projectile make when hitting the terrain
            {
				...
				/*if (Main.rand.Next(10) == 0){
					Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, (mod.ItemType("ShurikenOfTheEarth")));
				}*/
