...
{
    public class ThrowOfLight : ModItem
	
    {
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Throw Of Light");
			Tooltip.SetDefault("Lit");
		}
        public override void SetDefaults()
        {   item.damage = 45;           //this is the item damage
            ...
            item.shoot = mod.ProjectileType("ThrowOfLightProjectile"); 
