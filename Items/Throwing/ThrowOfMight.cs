...
{
    public class ThrowOfMight : ModItem
	
    {
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Throw Of Might");
			Tooltip.SetDefault("Mighty");
		}
        public override void SetDefaults()
        {   item.damage = 65;           //this is the item damage
            ...
            item.shoot = mod.ProjectileType("ThrowOfMightProjectile"); 
