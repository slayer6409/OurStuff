...
{
    public class ThrowOfFlight : ModItem
	
    {
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Throw Of Flight");
			Tooltip.SetDefault("Flighty");
		}
        ...
        {   item.damage = 50;           //this is the item damage
            ...
            item.shoot = mod.ProjectileType("ThrowOfFlightProjectile"); 
