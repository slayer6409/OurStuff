...
namespace OurStuff.Items.Throwing
{
	...
	
    {
		...
		{
			DisplayName.SetDefault("True Night's Throw");
			Tooltip.SetDefault("True Nighty");
		}
        public override void SetDefaults()
        {   item.damage = 72;           //this is the item damage
            ...
            item.shoot = mod.ProjectileType("TrueNightsThrowProjectile"); 
        ...
        public override void AddRecipes()  //How to craft this item
        {
            ...
            recipe.AddIngredient(mod, "NightsThrow");
