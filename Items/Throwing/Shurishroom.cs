...
{
    public class Shurishroom : ModItem
	
    {
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Shurishroom");
			Tooltip.SetDefault("Shroomy");
		}
        public override void SetDefaults()
        {   item.damage = 10;           //this is the item damage
            ...
            item.shoot = mod.ProjectileType("ShurishroomProjectile"); 
