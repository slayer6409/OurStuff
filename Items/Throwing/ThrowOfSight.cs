...
{
    public class ThrowOfSight : ModItem
	
    {
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Throw Of Sight");
			Tooltip.SetDefault("Sighty");
		}
        public override void SetDefaults()
        {   item.damage = 53;           //this is the item damage
            ...
            item.shoot = mod.ProjectileType("ThrowOfSightProjectile"); 
