...
{
    public class TrueHallowedShuriken : ModItem
	
    {
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("True Hallowed Shuriken");
			Tooltip.SetDefault("TrueHallowedy");
		}
        ...
        {   item.damage = 70;           //this is the item damage
            ...
            item.shoot = mod.ProjectileType("TrueHallowedShurikenProjectile"); 
        ...
        public override void AddRecipes()  //How to craft this item
        {
            ...
            recipe.AddIngredient(mod, "HallowedShuriken",500);
            recipe.AddIngredient(mod, "BrokenShuriken");
