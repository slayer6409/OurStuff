...
{
    public class DrownedShuriken : ModItem
	
    {
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Drowned Shuriken");
			Tooltip.SetDefault("It's wet");
		}
        ...
        {   item.damage = 23;           //this is the item damage
            ...
            item.shoot = mod.ProjectileType("DrownedShurikenProjectile"); 
