...
{
    public class ShurikenOfTheMoon : ModItem
	
    {
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Shuriken Of The Moon");
			Tooltip.SetDefault("Moony");
		}
        ...
        {   item.damage = 120;           //this is the item damage
            ...
            item.shoot = mod.ProjectileType("ShurikenOfTheMoonProjectile"); 
