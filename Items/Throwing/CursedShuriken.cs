...
{
    public class CursedShuriken : ModItem

    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Cursed Shuriken");
            Tooltip.SetDefault("It's Cursed");
        }
        public override void SetDefaults()
        {
            item.damage = 55;           //this is the item damage
            ...
            item.shoot = mod.ProjectileType("CursedShurikenProjectile");
