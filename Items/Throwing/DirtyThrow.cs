...
{
    public class DirtyThrow : ModItem
	
    {
		
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Dirty Shuriken");
			Tooltip.SetDefault("Not very useful");
		}
        public override void SetDefaults()
        {   item.damage = 2;           //this is the item damage
            ...
            item.shoot = mod.ProjectileType("DirtyThrowProjectile"); 
